...
pub(crate) fn _read_stdin<R: BufRead>(reader: &mut R) -> String {
...
// Create a utilities.rs file in the src directory and define a public module with a function:
// src/utilities.rs
...
// Use it in tests or other modules:
// use cli_utils::utilities::greet_user;
